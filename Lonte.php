...
#Dilarang copyright Mr.004 - AndroTech1733 2018 15 08 12:30
...
echo $BB."\n::#:Author ::[Mr.004,Beni_Hat12,Mr.003,Mr.006]#";

echo $B."\n::#:Instagram ::[@Rasyid004_:]#";

echo $RR."\n::#:Github ::[http://github.com/Mr.004:] #";

echo $R."\n::#:Facebook ::[Rasyid_004:] #";

echo $G."\n::#:YouTube ::[Gamer 4 LIve:] #";

echo $GG."\n::#:Team ::[004 CYEBER TEAM] #";
...
if(is_numeric($argv[1])) {
	...
	echo "[]Pross Asw Spam SmS[] #".$G.$argv[1].$X."\n";
	...
	while(1) {
		...
		echo "[]Tols Sending Massage To[] # ".$G.$argv[1].$X."\n";	
...
echo "[]Prossessing spam sms Asw[] #".$G.$argv[2].$X."\n";
